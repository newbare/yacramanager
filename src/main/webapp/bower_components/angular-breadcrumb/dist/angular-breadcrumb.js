...
function BreadcrumbDirective($interpolate, $breadcrumb, $rootScope) {
    this.$$templates = {
        bootstrap2: '<ul class="breadcrumb">' +
            ...
            '</li>' +
            '</ul>',
        bootstrap3: '<ol class="breadcrumb" id="main-breadcrumb">' +
            '<li ng-repeat="step in steps" ng-class="{active: $last}" ng-switch="$last">' +
            '<a ng-switch-when="false" href="{{step.ncyBreadcrumbLink}}"><i class="fa fa-home" ng-show="$first"></i>{{step.ncyBreadcrumbLabel}}</a> ' +
