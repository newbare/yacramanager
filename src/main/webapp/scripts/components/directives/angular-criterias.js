						...
						function($sce, $timeout, $templateCache, $q, $http,
							...
							return {
								...
								link : function($scope, element, attrs) {
									...
									var textFilterTemplate = _contextPath + 'scripts/templates/criteria/criteria-text.tpl.html';
									var checkBoxFilterTemplate = _contextPath + 'scripts/templates/criteria/criteria-checkbox.tpl.html';
									var dateFilterTemplate = _contextPath + 'scripts/templates/criteria/criteria-date.tpl.html';
									var booleanFilterTemplate = _contextPath + 'scripts/templates/criteria/criteria-boolean.tpl.html';
									var comparatorFilterTemplate = _contextPath	+ 'scripts/templates/criteria/criteria-comparator.tpl.html';
