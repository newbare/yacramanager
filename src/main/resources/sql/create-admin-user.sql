...
INSERT INTO users(
            ...
            username, createdby_id, lastmodifiedby_id)
...
INSERT INTO personne(
    ...
    VALUES (NULL, 'Admin', NULL, 'Admin', (SELECT id FROM users WHERE username='admin'), NULL);
...
INSERT INTO company(
    ...
    VALUES (nextval('hibernate_sequence'), current_date, current_date, 'YACRAMANAGER', current_date, 
            (SELECT id FROM users WHERE username='admin'), (SELECT id FROM users WHERE username='admin'));
...
INSERT INTO companyaccountinfo(
    ...
    VALUES (nextval('hibernate_sequence'), current_date, current_date, current_date + integer '365', false, (SELECT id FROM users WHERE username='admin'), 
            (SELECT id FROM users WHERE username='admin'), (select id FROM company where name='YACRAMANAGER'));
...
INSERT INTO employe(
    ...
    VALUES ((SELECT id FROM users WHERE username='admin'), NULL, (select id FROM company where name='YACRAMANAGER'), NULL);

INSERT INTO users_roles(
            roleid, userid)
    VALUES ((SELECT id FROM role WHERE role='ROLE_ADMIN'), (SELECT id FROM users WHERE username='admin'));