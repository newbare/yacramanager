...
public class ProjectServiceImpl implements ProjectService {
    ...
    public <S extends Project> S save(S entity) {
        ...
        applicationEventPublisher
                .publishEvent(ActivityEvent.createWithSource(this).user().operation(activityOperation).onEntity(Project.class, save.getId()).dto(toProjectDTO(save)));
        return save;
    }
    ...
    public void delete(Long id) {
        ...
        applicationEventPublisher.publishEvent(ActivityEvent.createWithSource(this).user().operation(ActivityOperation.DELETE).onEntity(Project.class, id));
    }
        ...
        if (filter != null) {
            ...
            case TEXT:
                ...
                if ("global".equals(filterText.getField())) {
                    return Specifications.where(CommonSpecifications.likeIgnoreCase(filterText.getValue(), Project_.name))
     ...
     * (non-Javadoc)
     * 
     * @see fr.wati.yacramanager.services.ProjectService#toProjectDTO(fr.wati.
     * yacramanager.beans.Project)
     */
    @Override
    @Transactional
     ...
     * 
     * @see
     * fr.wati.yacramanager.services.ProjectService#findByClientAndId(fr.wati.
     * yacramanager.beans.Client, java.lang.Long)
     */
    @Override
     ...
     * 
     * @see
     * fr.wati.yacramanager.services.ProjectService#toProjectDTOs(java.lang.
     * Iterable)
     */
    @Override
     ...
     * 
     * @see
     * fr.wati.yacramanager.services.ProjectService#addEmployeToProject(fr.wati.
     * yacramanager.beans.Project, fr.wati.yacramanager.beans.Employe, boolean,
     * java.math.BigDecimal)
     */
    @Override
    @Transactional
    public void assignEmployeToProject(Long projectId, Long employeId, boolean teamLead, BigDecimal dailyRate) throws ServiceException {
    ...
    @Override
    @Transactional
    public void unassignEmployeFromProject(Long projectId, Long employeId) throws ServiceException {
        Employe employeFound = employeService.findOne(employeId);
        Project projectFound = findOne(projectId);
    ...
    public Specification<Project> getGlobalSpecification(String text) {
        return Specifications.where(CommonSpecifications.likeIgnoreCase(text, Project_.name)).or(CommonSpecifications.likeIgnoreCase(text, Project_.description));
    }
}
