...
public class EmployeServiceImpl implements EmployeService {
    ...
    private Logger logger = LoggerFactory.getLogger(EmployeServiceImpl.class);
    @Inject
    ...
    public <S extends Employe> S save(S entity) {
        ...
        applicationEventPublisher.publishEvent(ActivityEvent.createWithSource(this).user().operation(activityOperation).onEntity(Employe.class, save.getId()));
        return save;
    }
     ...
     * 
     * @see
     * fr.wati.yacramanager.services.EmployeService#registerEmploye(fr.wati.
     * yacramanager.web.dto.RegistrationDTO)
     */
    @Override
    ...
    public void processInvitation(Employe employe, CompanyTempInvitation givenInvitation) throws ServiceException {
        CompanyTempInvitation invitation = companyInvitationRepository.findInvitationWithToken(givenInvitation.getUserId(), givenInvitation.getCompanyId(),
                givenInvitation.getToken());
    ...
    public List<Employe> getManagedEmployees(Long requesterId) {
        ...
        Specifications<Employe> specifications = Specifications.where(EmployeSpecifications.hasManager(requester)).and(EmployeSpecifications.forCompany(requester.getCompany()));
        List<Employe> requesterManagedEmployees = employeRepository.findAll(specifications);
     ...
     * 
     * @see
     * fr.wati.yacramanager.services.SpecificationFactory#buildSpecification(fr.
     * wati.yacramanager.utils.Filter)
     */
    @Override
    ...
    @Override
    public void createNewEmployee(EmployeDto employeDto, Long companyId, Long managerId) {
     ...
     * 
     * @see
     * fr.wati.yacramanager.services.EmployeService#findByContact_Email(java.
     * lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see fr.wati.yacramanager.services.EmployeService#resetPassword(fr.wati.
     * yacramanager.beans.Employe)
     */
    @Override
    ...
    @Override
    public List<Employe> getEmployeesAssignedToTask(Long requesterId, Long taskId) {
     ...
     * (non-Javadoc)
     * 
     * @see fr.wati.yacramanager.services.EmployeService#findByEmail(java.lang.
     * String)
     */
    @Override
     ...
     * 
     * @see
     * fr.wati.yacramanager.services.EmployeService#updateUserRights(java.lang.
     * Long, java.util.List)
     */
    @Override
    @Transactional
    public void updateUserRights(Long employeeId, List<String> roles) throws ServiceException {
    ...
    public Specification<Employe> getGlobalSpecification(String text) {
        return Specifications.where(EmployeSpecifications.firstNamelike(text)).or(EmployeSpecifications.lastNamelike(text));
    }
